...
st.set_page_config(
    page_title="11701 - Unsupervised Learning",  
...
if uploaded_file is not None:
    ...
    st.markdown("<h1 style='text-align: center;'>Unsupervised Learning - 11701</h1>", unsafe_allow_html=True)  # YYYYY diisi dengan nama panggilan
    st.dataframe(input_data)

    
    model_directory = r'C:\Users\yudhika wira utama\Downloads\ML\Tugas_Modul4_B_wir_11701'
    model_path = {
